...
describe('appTests', function () {
  ...
  it('displayBooksWithReviews() should display ' + booksData.length + ' book nodes', function () {
    //given
    var parentEl = document.createElement('div');

    //when
    displayBooksWithReviews(parentEl, parseBooksData(booksData, reviewsData));
  ...
  it('displayBooksWithReviews() should not render ul when there are no reviews for book', function() {
    var parentEl = document.createElement('div');
  ...
  it('displayBooksWithReviews() should not render ol when there are no books', function() {
    var parentEl = document.createElement('div');
